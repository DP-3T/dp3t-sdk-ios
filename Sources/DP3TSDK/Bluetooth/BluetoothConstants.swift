...
enum BluetoothConstants {
    ...
    static var peripheralReconnectDelay: Int = 60 * 2
    ...
    static var peripheralDisposeInterval: TimeInterval = 15 * 60
    static var peripheralDisposeIntervalSinceDiscovery: TimeInterval = 15 * 60
